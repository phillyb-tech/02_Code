...
if __name__ == "__main__":
    ...
    print(f"{'Scenario':<32} {'Daily':>10} {'Scans/Day':>12} {'Addl/Day':>12} {'Addl/Day':>12} {'Monthly':>12} {'Annual':>14} {'Robot':>8} {'Scanner':>10} {'Idle':>12}")
    print(f"{'':32} {'(All 6)':>10} {'(per scan)':>12} {'(per scan)':>12} {'(Total)':>12} {'Addl CM':>12} {'Addl CM':>14} {'Util %':>8} {'Util %':>10} {'min/day':>12}")
    print('-'*140)

    for row in financial_table_data:
        scenario = row["Scenario"]
        daily = row["Daily Scans (All 6)"]
        per_scanner = row["Scans per Day (per scanner)"]
